...
Systems thinking helps us to think sustainably when we are able to think systemically and view systems from multiple angles. We can analyze a system on different levels, focusing on one level at a time while temporarily ignoring the underlying layers.
...
At a basic level, systems can be sketched by hand or using digital drawing tools. They can also be described in text documents. While it's possible to create models using hand drawings, documents, and spreadsheets, many software tools make the process more efficient. The advantage of specialized system modeling tools is that they are tailored for specific tasks and capable of handling large volumes of data with visualizations. The most advanced tools can even identify patterns and correlations using AI and machine learning.
...
- What pitfalls can we expect in our work with digital development?  
- How confident are we in our assumptions about our development work and what goes against them?  
- What do we do if our assumptions turn out to be wrong?  
- Is there a logical connection between all our assumptions?  
...
An example from the digital world could be recycling systems for used electronics, such as Apple's trade-in program. Here, Apple takes the back old Apple products and offers gift cards for the return. Apple's electronics contain plastic, metal and more or less recyclable materials, and it sounds positive if a manufacturer has a program for recycling electronics. From a more critical angle, it is important to ask whether users actually have the incentive and opportunity to return the products. 

- Is it easy to return the electronics?  
- Is it worth it?  
- Is there a danger that most users won't return the electronics and they will end up as e-waste anyway?  
- Is it just a clever marketing ploy or does the company actually manage to recycle the electronics?  

By asking critical questions about the subsystems in the domain and its context, we can be more precise in our development work.
...
## Sustainable digitization can be seen in the interaction between systems
...
As with all IT projects, there is always a risk that development will fail. But by considering the five dimensions of sustainability, we can help develop more sustainable systems and actually reduce risks for the future. Although this example was a digitization project, the sustainability implications of such an analysis would extend beyond the digital. In this case, for example, it would make sense to also review the shop's product range in terms of sustainability dimensions.

Questions you can also ask are: 
...
Here again, you can analyze the system to get some good answers – especially in relation to the boundaries of the system.
...
Network science is not about the individual parts of a system. Instead, it focuses on understanding the network of systems themselves, the connections between the elements of the systems and their interaction with the outside world.

Network science seeks to find general rules and relationships that are common to all kinds of networks, such as social media, financial networks or ecological systems. Network science can be used to investigate how, for example, information spreads in a network or how the structure of the network affects the properties of the system. Today, this is possible because we are able to collect huge amounts of data, analyze it with advanced statistical analysis, and perform calculations and simulations with high-speed computers. 
...
For example, you can analyze how your company's energy consumption affects the climate and contributes to global temperature increases. You can develop models of the company's supply chains to better understand scope 3 emissions or the sourcing of components for the company's products. It may also be relevant to analyze the organization's effects on the local community or on users to demonstrate social responsibility.

In all cases, critical and analytical system thinking is necessary. By bringing system models or network diagrams into play, you can better understand the complex relationships that shape your organization. Ask yourself the following questions when you want to work systemically and critically with your field:

Q> - Which systems are part of the problem?  
...
- What cascading effects can there be between systems?  
- What synergies can be found between the systems?  

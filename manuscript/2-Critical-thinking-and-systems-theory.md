...
At the same time, this data collection also has ethical and legal implications. In the EU, the GDPR protects users by setting limits on what personal data is collected and how it is used; comparable laws — such as California's CPRA, Brazil's LGPD and China's PIPL — play a similar role elsewhere. It may also be unethical to collect certain types of user data, even if we have the ability to do so. It is therefore important to think broadly when making adjustments to digital systems so that long-term considerations are taken into account when developing instead of one-off solutions.
...
You will often need to apply systems thinking in your work with digital sustainability. When a company prepares ESG reports or statutory sustainability disclosures (such as CSRD reports in the EU), it is crucial to understand how the company's activities affect other systems.

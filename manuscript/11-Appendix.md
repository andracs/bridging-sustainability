...
4. **Use agile development methods and open source** Sustainability within IT is still relatively uncharted territory, which is why iterative development with long-term goals and short iterations is often preferable.
...
8. **Aim for low energy and material consumption** Choose solutions with lower direct and indirect energy consumption to minimize the solution's CO2 emissions.
    
9. **Less is more** Small and simple solutions often use less energy and fewer resources than large solutions. Consider whether downsizing or lightweight design could be viable strategies.
    
10. **Design for (cyber)security and resilience** Solutions that can be hacked or misused are not sustainable. Ensure high IT security standards.
...
- Ensure that waste sorting at the end of the lifecycle is responsible.
...
**3. Is the operation based on renewable energy?**
...
**4. Is the data center design eco-friendly regarding cooling?**
...
- [The Karlskrona Manifesto for Sustainable Design](https://sustainabilitydesign.org/)
    
- [W3C's Web Sustainability Guidelines](https://w3c.github.io/sustyweb/)
    
- [The Blue Angel certification for software](https://www.blauer-engel.de/en/products/software)
    
- [Application Security Verification Standard (ASVS)](https://owasp.org/www-project-application-security-verification-standard/) and
...
2. **Monitor resource consumption and environmental impact** to be able to make qualified decisions about future improvements.
    
3. **Use efficient and tested algorithms**, because otherwise, you incur technical debt for the future.
    
4. **Design for modularity and reusability** to save on development costs.
    
5. **Ensure the software is open for extension and integration**, to make it possible to combine different solutions and create new or more efficient products.

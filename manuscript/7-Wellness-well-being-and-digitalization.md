...
An attempt to compile criticism and research documenting the problematic conditions can be found on the website "Ledger of Harms" ([Center of Humane Technology](https://ledger.humanetech.com/)). In their "Ledger of Harms", the Center works with eight categories of harms that have been given the headings and explanations you can see below - they are supported on the website with quotes from research reports.
...
From the foreword you can read:
